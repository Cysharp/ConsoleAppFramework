...
internal static partial class ConsoleApp
{
    ...
    public static ConsoleAppBuilder CreateBuilder()
...
public partial struct ConsoleAppBuilder
{
...
""");
    ...
    static void EmitConsoleAppBuilder(SourceProductionContext sourceProductionContext, ImmutableArray<(InvocationExpressionSyntax Node, string Name, SemanticModel Model)> generatorSyntaxContexts)
    {
        ...
        var commands = group1["Add"]
            ...
            {
                // TODO: Add<T> handling
                var parser = new Parser(sourceProductionContext, x.Node, x.Model, wellKnownTypes);
        ...
        var run = group1["Run"];
        var runAsync = group1["RunAsync"];

        var emitter = new Emitter(wellKnownTypes);


        emitter.EmitBuilder(commands!, false); // TODO: isRunAsync
    }
}