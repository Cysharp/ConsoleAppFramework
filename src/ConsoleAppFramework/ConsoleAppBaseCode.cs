...
internal static partial class ConsoleApp
{
    ...
    internal partial class ConsoleAppBuilder
    {
        ...
        /// <summary>
        /// Configures typed global options. T can be any type with a parameterless constructor.
        /// The source generator will emit parsing code for all properties of T.
        /// </summary>
        /// <typeparam name="T">Type to use for global options</typeparam>
        public ConsoleAppBuilder ConfigureGlobalOptions<T>() where T : new()
        {
            // Marker method - actual implementation generated by source generator
            return this;
        }
