...
public class Benchmark
{
    ...
    private static readonly string[] Arguments2 = { "--str", "hello world", "--i", "13", "--b" };
    ...
    {
        ConsoleApp.Run(Arguments2, static (string str, int i, bool b) => { });
    }

    //[Benchmark(Description = "ConsoleAppFramework v5(FP)")]
    //public unsafe void ExecuteConsoleAppFramework5_2()
    //{
    //    ConsoleApp.Run(Arguments2, &Run);

    //    static void Run(string str, int i, bool b)
    //    {
    //    }
    //}
}